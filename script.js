document.addEventListener('DOMContentLoaded', () => {
    ...
    function changeSlide(newIndex) {
      ...
      timeline.add({
        targets: items[newIndex].querySelectorAll('.img'),
        opacity: [0, 1],
        translateX: [-100, 0],
...
// Function to display current question and choices
  function  displayquestion() {
    // Get current quiz data
      let currentquizdata= generaldata[question];
      // Display question
      questionplaceholder.textContent =currentquizdata.question;
...
function nature(){
  document.querySelector(".choosetopic").style.display = "none";
    ...
    function  displayquestion() {
      // Get current quiz data
        let currentquizdata= naturedata[question];
        // Display question
        questionplaceholder.textContent =currentquizdata.question;
        choiceplaceholder.innerHTML = '';
        // Display choices as buttons
...
function capitals(){
  document.querySelector(".choosetopic").style.display = "none";
    ...
    function  displayquestion() {
      // Get current quiz data
        let currentquizdata= capitalsdata[question];
        // Display question
        questionplaceholder.textContent =currentquizdata.question;
        choiceplaceholder.innerHTML = '';
        // Display choices as buttons
...
function sports(){
  document.querySelector(".choosetopic").style.display = "none";
    ...
    function  displayquestion() {
      // Get current quiz data
        let currentquizdata= sportsdata[question];
        // Display question
        questionplaceholder.textContent =currentquizdata.question;
        choiceplaceholder.innerHTML = '';
        // Display choices as buttons
